...
\begin{document}
	...
	\paragraph{Betriebsmittel}Unterscheidung: \textit{entziebare, nicht emtziebare,} sowie \textit{exklusiv} oder \textit{shared}\\
	\ccontent{
	\begin{tabularx}{\columnwidth}{|l|X|}
		\cline{1-2}
		reale Betriebsmittel & Prozessoren, Speicher, Dateien, Geräte \\
		\cline{1-2}
		virtuelle Betriebsmittel & virtueller Speicher, Prozessoren, Koprozessoren \\
		\cline{1-2}
	\end{tabularx}}
